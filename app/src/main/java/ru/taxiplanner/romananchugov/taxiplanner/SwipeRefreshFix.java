...
/**
 * Created by romananchugov on 06.02.2018.
 */

public class SwipeRefreshFix extends SwipeRefreshLayout{
    private ViewGroup container;

    public SwipeRefreshFix(Context context) {
        super(context);
    }

    public SwipeRefreshFix(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
...
//        }
        ...
        return container.canScrollVertically(-1);
    }
